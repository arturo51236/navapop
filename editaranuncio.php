        ...
        <section>
            ...
            <div class="nuevoA">
                <form action="editaranuncio.php" method="post" enctype="multipart/form-data" id="formeditar">
                    <label>Nombre: </label><input type="text" name="nombre" placeholder="Modifica el nombre del anuncio" required value="<?= $anuncioAnterior->getNombre() ?>"><br>
                    ...
                    <input type="submit" value="Editar anuncio"><br>
                </form>
            </div>
            <div>
